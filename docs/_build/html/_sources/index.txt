...
================================================================================
 ...
 - project page:       http://saga-project.github.com/troy/
 - api documentation:  http://saga-project.github.com/troy/docs/troy/
 - wiki etc:           https://github.com/saga-project/troy/wiki/


**NOTE:** the Troy development follows the `git-flow`_ branching model.

.. _git_flow : http://nvie.com/posts/a-successful-git-branching-model/



TROY, a Tiered Resource Overlay
================================================================================
...
--------------------------------------------------------------------------------
 ...
 in the API documentation in more detail:
   ...
   * :class:`troy.Config`      (Troy configuration dictionary)
...
[2] http://arxiv.org/abs/1207.6644v1                               
[3] https://github.com/saga-project/BigJob/                        
[4] https://twiki.cern.ch/twiki/bin/view/ArdaGrid/DIANETutorial    
[5] https://github.com/saga-project/troy/wiki/                     
...
.. toctree::
   ...
   troy/__init__.rst
   troy/engine/__init__.rst
   troy/interface/__init__.rst
   troy/adaptors/__init__.rst
