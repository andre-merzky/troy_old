...
''' Concepts
    ...
    The :class:`troy.Troy` class is the user (or application) facing component of Troy.
    ...
    Troy as Application Level Scheduler
    -----------------------------------
    ...
    **Contents:**
    ...
    Troy as Abstraction for Pilot Frameworks
    ----------------------------------------
    ...
    **Contents:**
    ...
    .. toctree::
       ...
       compute_pilot_description
       compute_pilot
       compute_unit_description
       compute_unit
    
       data_pilot_description
       data_pilot
       data_unit_description
       data_unit
    

    Troy Utility Classes
    --------------------
...
from troy.attributes                     import Callback,  Attributes, _AttributesBase
