...
from troy.exception import Exception as Exception
from troy.exception import Error     as Error
...
# FIXME: clearer / more consistent method naming (privs)
...
class Attributes (_AttributesBase) :
    ...
    def __init__ (self, *args, **kwargs) :
        ...
        :func:`troy.Attributes._attributes_t_init` makes sure that the basic structures are in
    ...
    def _attributes_t_init (self, key=None) :
        ...
        The :func:`troy.Attributes._attributes_t_init` method initializes the interface's
    ...
    def _attributes_t_conversion (self, key, val) :
        ...
        calling :func:`troy.Attributes._attributes_add_check` (key, check).
        """
    ...
    def _attributes_t_conversion_flavor (self, key, val) :
        """ 
        This internal function is not to be used by the consumer of this API.
        This method should ONLY be called by :func:`troy.Attributes._attributes_t_conversion`! 
        """
    ...
    def _attributes_i_set (self, key, val=None, force=False) :
        ...
        :func:`troy.Attributes._attributes_add_check` (key, callable).
    ...
    def _attributes_register_deprecated (self, key, alias) :
        ...
        registered before (via :func:`troy.Attributes._attributes_register`)::
    ...
    def _attributes_set_setter (self, key, setter) :
        ...
        See documentation of :func:`troy.Attributes._attributes_set_setter` for details.
        """
