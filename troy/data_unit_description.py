...
class DataUnitDescription (Attributes) :
    ...
    The description is used via :class:`troy.Troy` or an :class:`troy.PilotFramework` to instantiate
    :class:`troy.DataUnit`s, i.e. physical data representations, which are managed by
