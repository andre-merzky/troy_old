...
class DataUnitService (Base) :
    ...
    L{DataPilotService} instances -- those instances can be added to
    ...
    the set of participating L{DataPilotService}s and their L{DataPilot}s.
    ...
    def remove_pilot_service (self, dps) :
        ...
        Note that it won't cancel the DataPilotService's Pilots, they will just
